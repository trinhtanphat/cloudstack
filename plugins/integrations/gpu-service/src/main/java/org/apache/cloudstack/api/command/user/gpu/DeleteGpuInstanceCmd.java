...
@APICommand(name = "deleteGpuInstance",
            description = "Delete a GPU service instance",
            responseObject = GpuInstanceResponse.class,
            responseView = ResponseView.Restricted,
            authorized = {RoleType.Admin, RoleType.ResourceAdmin, RoleType.DomainAdmin, RoleType.User})
public class DeleteGpuInstanceCmd extends BaseCmd {
    ...
    public void execute() throws ServerApiException {
        GpuInstanceResponse response = gpuService.deleteGpuInstance(this);
